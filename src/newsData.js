...
export const newsData = [
  {
    ...
    description: `The move comes after nearly two years since PayPal enabled users to buy and sell crypto on its platform.
  ...
  },
  {
    ...
    description: `Crypto traders in Italy will be subject to a 26% capital-gains tax starting in 2023, according to a new budget that won parliamentary approval on Thursday.
